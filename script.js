...
customAutoReply(customMessage, "Det funket!");
...
function loopThrough(arr) {
  fiveWords.forEach((value, index) => {
    console.log(value, index);
  });
  threeFruits.forEach((value, index) => {
    console.log(value, index);
  });
}
...
const result = (arr) => arr.filter((numb) => numb % 2 === 0);
console.log(result(nums));
const result1 = (arr) => arr.filter((numb) => numb % 2 );
console.log(result1(nums2))
